...
[Intro to the Cloud Course on DigitalOcean](https://www.digitalocean.com/community/curriculums/introduction-to-the-cloud)

[DigitalOcean Cloud Platform Fundamentals on Udemy](https://www.udemy.com/course/digitalocean/)

[Top DigitalOcean Courses on Udemy](https://www.udemy.com/topic/DigitalOcean/)
...
[GitHub Actions](https://github.com/digitalocean/action-doctl) is a service that automates DigitalOcean infrastructure in response to activity on Github.
...
[DigitalOcean Monitoring](https://www.digitalocean.com/products/monitoring/) is a service that monitors applications and infrastructure resource usage with built in monitoring and alerting.

[DigitalOcean Projects](https://www.digitalocean.com/docs/projects/) is a service that organizes your resources into groups that fit the way you work.

[DigitalOcean Teams](https://www.digitalocean.com/products/teams/) is a service that let's you collaborate with others to manage and scale infrastructure without sharing credentials.

[DigitalOcean Droplets](https://www.digitalocean.com/products/droplets/) is a service that provides on-demand Linux virtual machines. Choose from shared CPU and dedicated CPU plans, with variable amounts of RAM, locally attached SSD storage, and generous transfer quotas.

[Kubernetes](https://www.digitalocean.com/products/kubernetes/)is a service that provides an easy-to-use managed Kubernetes service, providing you uptime, scalability, and portability for your cloud native apps. Free control plane included.

[DigitalOcean App Platform](https://www.digitalocean.com/products/app-platform/) is a service that builds, deploys, and scale apps quickly using a simple, fully managed solution. We’ll handle the infrastructure, app runtimes and dependencies, so you can focus on your code.

[Spaces Object Storage](https://www.digitalocean.com/products/spaces/) is a service that stores and scales vast amounts of data without worrying about compute server storage limits. Manage your data with S3-compatible tools.

[Spaces Content Delivery Network](https://www.digitalocean.com/products/spaces/) is a service that quickly delivers data from Spaces with a built-in content delivery network that is close to end users.

[Volumes Block Storage](https://www.digitalocean.com/products/block-storage/) is a service that adds storage to your compute servers as needed.

[Cloud Firewalls](https://www.digitalocean.com/products/cloud-firewalls/) is a service that protects your applications by filtering out unwanted traffic. Filtering occurs upstream and in front of your server infrastructure.

[Load Balancers](https://www.digitalocean.com/products/load-balancer/) is a service that scales your applications more easily with a highly available load balancing service that directs users to available resources.

[Virtual Private Cloud (VPC)](https://www.digitalocean.com/products/vpc/) is a service that improves your application security with your own private network, which restricts traffic to resources provisioned on your same account.

[Floating IPs](https://digitalocean.com/docs/networking/floating-ips) is a service that increases availability by easily switching incoming traffic across your server infrastructure.

[DNS](https://digitalocean.com/docs/networking/dns) is a service that provides reliable resolutions with a scalable domain name system (DNS) service.

[Managed PostgreSQL](https://www.digitalocean.com/products/managed-databases-postgresql/) is a service for DigitalOcean's [PostgreSQL](https://www.postgresql.org/) hosting.

[Managed MySQL](https://www.digitalocean.com/products/managed-databases-mysql/) is a service for DigitalOcean's [MySQL](https://www.mysql.com/) hosting
...
**[Start building with Ruby on the DigitalOcean API](https://developers.digitalocean.com/documentation/v2/#account)**
...
**[Start building with Go on the DigitalOcean API](https://developers.digitalocean.com/documentation/v2/#account)**
...
- [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/DigitalOcean-Guide/pulls).
